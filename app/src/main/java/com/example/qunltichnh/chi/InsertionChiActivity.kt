...
class InsertionChiActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_insertion_chi)
        ...
        //nút thoát
        val imgBtnBackChi= findViewById<ImageButton>(R.id.imgBtnBackChi)
        ...
        val txtTimeChi = findViewById<TextView>(R.id.txtTimeChi)
        val txtDateChi = findViewById<TextView>(R.id.txtDateChi)
        //thời gian thực
        ...
        // Nút chọn ảnh
        val btnAnhChi = findViewById<Button>(R.id.btnAnhChi)
        btnAnhChi.setOnClickListener {
            showImagePickerDialog()
        }

        // Nút lưu thông tin
        val btnSaveChi = findViewById<Button>(R.id.btnSaveChi)
    ...
    private fun uploadImage(uri: Uri) {
        ...
        currentUser?.let { user ->
            ...
            val imageRef = storageRef.child(userId).child("Nam").child("Chi").child("image/${uri.lastPathSegment}")   //ảnh đi kèm với định dạng của ảnh
    ...
    private fun saveEmployeeData() {
        val currentUser = auth.currentUser
        val edtKhoanChi = findViewById<EditText>(R.id.edtKhoanChi)
        val edtLuongChi = findViewById<EditText>(R.id.edtLuongChi)
        currentUser?.let { user ->
            val userId = (user.email?: "").substringBefore("@")   //firebase ko nhận dấu @ và . nên chỉ lấy phần trước dấu @ của gmail
            val empDateChi = findViewById<TextView>(R.id.txtDateChi).text.toString()
            val empTimeChi = findViewById<TextView>(R.id.txtTimeChi).text.toString()
            val empKhoanChi = findViewById<EditText>(R.id.edtKhoanChi).text.toString()
            val empLuongChi = findViewById<EditText>(R.id.edtLuongChi).text.toString()
