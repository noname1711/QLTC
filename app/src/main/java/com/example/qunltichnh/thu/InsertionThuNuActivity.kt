...
class InsertionThuNuActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_insertion_thu_nu)
        ...
        //nút thoát
        val imgBtnBackNu= findViewById<ImageButton>(R.id.imgBtnBackNu)
        imgBtnBackNu.setOnClickListener{
            finish()
        }
        //pick thời gian mặc định là thực hoặc tùy chọn
        val btnLich = findViewById<ImageButton>(R.id.BtnLichNu)
        val btnDongHo = findViewById<ImageButton>(R.id.BtnDongHoNu)
        val txtTime = findViewById<TextView>(R.id.txtTimeNu)
        val txtDate = findViewById<TextView>(R.id.txtDateNu)
        //thời gian thực
        ...
        // Nút chọn ảnh
        val btnAnhThu = findViewById<Button>(R.id.btnAnhThuNu)
        btnAnhThu.setOnClickListener {
            showImagePickerDialog()
        }

        // Nút lưu thông tin
        val btnSaveThu = findViewById<Button>(R.id.btnSaveThuNu)
    ...
    private fun uploadImage(uri: Uri) {
        ...
        currentUser?.let { user ->
            ...
            val imageRef = storageRef.child(userId).child("Nu").child("Thu").child("image/${uri.lastPathSegment}")  //ảnh đi kèm với định dạng của ảnh
    ...
    private fun saveEmployeeData() {
        val currentUser = auth.currentUser
        val edtKhoanThu = findViewById<EditText>(R.id.edtKhoanThuNu)
        val edtLuongThu = findViewById<EditText>(R.id.edtLuongThuNu)

        currentUser?.let { user ->
            val userId = (user.email?: "").substringBefore("@")   //firebase ko nhận dấu @ và . nên chỉ lấy phần trước dấu @ của gmail
            val empDate = findViewById<TextView>(R.id.txtDateNu).text.toString()
            val empTime = findViewById<TextView>(R.id.txtTimeNu).text.toString()
            val empKhoanThu = findViewById<EditText>(R.id.edtKhoanThuNu).text.toString()
            val empLuongThu = findViewById<EditText>(R.id.edtLuongThuNu).text.toString()
