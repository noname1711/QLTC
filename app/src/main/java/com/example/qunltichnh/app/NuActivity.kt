...
import com.example.qunltichnh.anh.AnhNuActivity
import com.example.qunltichnh.chi.InsertionChiNuActivity
import com.example.qunltichnh.custom.CustomGridView
import com.example.qunltichnh.dothi.DoThiNamActivity
import com.example.qunltichnh.dothi.DoThiNuActivity
import com.example.qunltichnh.fetching.FetchingNuActivity
import com.example.qunltichnh.outdata.OutDataGv
import com.example.qunltichnh.thu.InsertionThuNuActivity
...
class NuActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //về lại màn app
        val imgBtnBackAppNu = findViewById<ImageButton>(R.id.imgBtnBackAppNu)
        imgBtnBackAppNu.setOnClickListener{
            val i = Intent(this@NuActivity, AppActivity::class.java)
            startActivity(i)
        }
        // hiển thị màn cho data người dùng đã nhập
        val btnDataNu = findViewById<ImageButton>(R.id.btnDataNu)
        btnDataNu.setOnClickListener{
            val i = Intent(this@NuActivity, FetchingNuActivity::class.java)
            startActivity(i)
        }
        //hiển thị hình ảnh bill thu chi
        val btnAnhNu = findViewById<ImageButton>(R.id.btnAnhNu)
        btnAnhNu.setOnClickListener{
            val i = Intent (this@NuActivity, AnhNuActivity::class.java)
            startActivity(i)
        }
        //hiển thị dữ liệu dưới dạng đồ thị
        val btnDoThiNu = findViewById<ImageButton>(R.id.btnDoThiNu)
        btnDoThiNu.setOnClickListener{
            val i = Intent(this@NuActivity, DoThiNuActivity::class.java)
            startActivity(i)
        }
        //về lại đầu trang
        val scrollViewNu = findViewById<ScrollView>(R.id.scrollViewNu)
        val btnFirstNu = findViewById<FloatingActionButton>(R.id.btnFirstNu)
        btnFirstNu.setOnClickListener {
            scrollViewNu.smoothScrollTo(0, 0)
        }
        //grid view cho thu
        val list = mutableListOf<OutDataGv>()
        list.add(OutDataGv(R.drawable.nu_di_lam, "  Làm việc"))
        list.add(OutDataGv(R.drawable.nu_lam_them, " Làm thêm"))
        ...
        list1.add(OutDataGv(R.drawable.nu_an, "   Ăn uống"))
        list1.add(OutDataGv(R.drawable.nu_trang_diem, "   Trang điểm"))
        list1.add(OutDataGv(R.drawable.nu_the_thao, "   Thể thao"))
        ...
        list1.add(OutDataGv(R.drawable.nu_du_lich, "    Healing"))
        ...
        val gvChi = findViewById<GridView>(R.id.gvChiNu)
        gvChi.adapter = customChi
        gvChi.onItemClickListener = AdapterView.OnItemClickListener { parent, view, position, id ->
            val intent = Intent(this, InsertionChiNuActivity::class.java)
            startActivity(intent)
        }

        val btnCheckTkNu = findViewById<Button>(R.id.btnCheckTkNu)
        btnCheckTkNu.setOnClickListener {
            ...
            currentUser?.let { user ->
                ...
                val employeeDataRefThu = databaseRef.child(userId).child("Nu").child("Thu")
                val employeeDataRefChi = databaseRef.child(userId).child("Nu").child("Chi")
        ...
        if (!initialNetworkStatus) {
            Toast.makeText(this@NuActivity, R.string.loss_internet, Toast.LENGTH_SHORT).show()
        }
    }
    ...
    private fun calculateAndShowDialog(totalLuongThu: Int, totalLuongChi: Int) {
        ...
        val txtTietKiem = findViewById<TextView>(R.id.txtTietKiemNu)
    ...
    private fun showDialogLai() {
        val builder = AlertDialog.Builder(this@NuActivity,R.style.Themecustom)
